...
using karachun_geo.API.Configurations.Autofac;
using karachun_geo.BI.Options;
using karachun_geo.EF;
...
using karachun_geo.API.Hubs;

namespace karachun_geo.API
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapHub<GeolocationHub>("/chatHub");
            });
        }
    }
}
